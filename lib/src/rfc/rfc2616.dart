...
final LWS = RegExp(RegExp.escape(CRLF) + '?[' + RegExp.escape(SP + HT) + ']+');

// ignore: non_constant_identifier_names
final TEXT = RegExp('(?:[' +
    RegExp.escape(OCTET.difference(CTL).join()) +
    ']|' +
    LWS.pattern +
    ')');
...
final token = RegExp('[' +
    RegExp.escape(CHAR.difference(CTL).difference(separators).join()) +
    ']+');
